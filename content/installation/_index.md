...
- Windows: [ZIP](https://github.com/hhanh00/zwallet/releases/download/v1.4.4/ywallet.zip)
- MacOS: [DMG](https://github.com/hhanh00/zwallet/releases/download/v1.4.4/ywallet-universal.dmg)
- Linux: [Flatpak](https://github.com/hhanh00/zwallet/releases/download/v1.4.4/ywallet.flatpak),
[AppImage](https://github.com/hhanh00/zwallet/releases/download/v1.4.4/Ywallet-latest-x86_64.AppImage)
...
{{<imgcaption windows.png Windows "https://github.com/hhanh00/zwallet/releases/download/v1.4.4/ywallet.zip">}}
{{<imgcaption linux.png Linux "https://github.com/hhanh00/zwallet/releases/download/v1.4.4/Ywallet-latest-x86_64.AppImage">}}
