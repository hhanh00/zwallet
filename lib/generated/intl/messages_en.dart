...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(num) => "${num} more signers needed";

  static String m9(ticker) => "Receive ${ticker}";

  static String m10(height) => "Rescan Requested from ${height}...";
