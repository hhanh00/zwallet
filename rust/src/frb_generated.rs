...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -41587817;
...
fn wire__crate__api__cdb__coin_open_db_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                (move || {
                    let output_ok =
                        crate::api::cdb::coin_open_db(api_coin, &api_filepath, &api_password)?;
                    Ok(output_ok)
                })(),
            )
        },
...
fn wire__crate__api__cdb__create_schema_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                (move || {
                    let output_ok = crate::api::cdb::create_schema(api_coin)?;
                    Ok(output_ok)
                })(),
            )
        },
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__cdb__coin_open_db_impl(ptr, rust_vec_len, data_len),
        3 => wire__crate__api__cdb__create_schema_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
